    ...
    return (
        <div className='paginator-wrapper'>
            ...
            className={prev ? 'paginator-wrapper__item active' : 'paginator-wrapper__item'}>
                <img src='https://cdn-icons-png.flaticon.com/512/271/271220.png' alt='' className='paginator-wrapper__prev-btn'/>
            </p>
            ...
            className={next ? 'paginator-wrapper__item active' : 'paginator-wrapper__item'}>
                <img src='https://cdn-icons-png.flaticon.com/512/271/271220.png' alt='' className='paginator-wrapper__next-btn'/>
            </p>
        </div>
    )
}
